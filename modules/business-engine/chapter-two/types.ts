...
export const emptyChapterTwoState = (): ChapterTwoState => ({ platformTenants: [], platformCompanies: [], platformDomains: [], branches: [], warehouses: [], roles: [], assistantMessages: [], assistantProposals: [], aiActivity: [], productMedia: [], mediaAcquisitionRequests:[], commerceProjections: [], commerceReservations: [], commerceOrders: [], commercePaymentMethods:[], commercePayments:[], commerceOrderHistory:[], users: [], memberships: [], customers: [], equipment: [], workOrders: [], products: [], inventory: [], suppliers: [], purchases: [], quotes: [], invoices: [], payments: [], cashMovements: [], history: [], events: [], fiscalConfigurations: [], electronicInvoices: [], audit: [], idempotency: {}, businessSessions: [], cashSessions: [], cashOperations: [], supportGrants: [], backupRecords: [], migrationRecords: [], platformErrors: [], expenses: [], reportRuns: [], passwordTokens: [], fiscalSequences: [], canonicalFiscalDocuments: [], fiscalReconciliations: [] });
